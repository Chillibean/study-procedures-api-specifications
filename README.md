# **Study Procedures API Specifications**
...
Welcome to the Study Procedures API Specifications repository, the central hub for all specifications and documentation related to Study Procedures API.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/Chillibean/study-procedures-api-specifications.git
...
This file is the cornerstone of our repository. It contains all the specs for the Study Procedures API API.
...
You can access the documentation at **[https://chillibean.github.io/study-procedures-api/](https://chillibean.github.io/%7B%7BapiPackageName%7D%7D-specifications/)**.

The OpenAPI JSON file is available at **[https://chillibean.github.io/study-procedures-api/schema.json](https://chillibean.github.io/%7B%7BapiPackageName%7D%7D-specifications/schema.json)**.
